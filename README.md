...
```bash
pip install git+https://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@github.com/darp4Co/darp4-shared-core.git
```
